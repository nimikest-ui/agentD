...
This project is indexed by GitNexus as **agentD** (1999 symbols, 2908 relationships, 44 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
